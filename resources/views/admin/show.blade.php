            ...
            <li class="list-group-item">
                <div class="results__items row">
                    <div class="results__leftpart col-sm-6 col-md-6">
                        <p class="results__vacancy">{{$article->name}}</p>
                    </div>
                    <div class="results__rightpart col-sm-6 col-md-6 text-right">
                    </div>
                </div>
            </li>
            <li class="list-group-item">
                <div class="vacancy">
                    ...
                    <div class="vacancy__reply row">
                        ...
                        <p id="share_button" onclick="shareaction()"
                           class=" vacancy__share col-sm-6 col-md-8 text-right " style="cursor: pointer">Share with
                            friend: <span
